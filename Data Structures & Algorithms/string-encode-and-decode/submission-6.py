...
class Solution:
    def encode(self, strs: List[str]) -> str:
        ...
        Use length-prefix: "length#string" format.
        Example: ["we","say"] → "2#we3#say"
        
        Works even if string contains '#' because we read exact
        number of characters based on the length prefix.
